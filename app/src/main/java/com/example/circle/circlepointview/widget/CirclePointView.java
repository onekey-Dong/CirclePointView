package com.example.circle.circlepointview.widget;
...
import com.example.circle.circlepointview.R;

/**
 * Created by onekey on 2019/2/23.
 */
...
public class CirclePointView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsSolid || mStrikeWidth >= value) {
            canvas.drawCircle(mWidth >>> 1, mHeight >>> 1, value, mDrawPoint);
            return;
        }
        value =  (value - (int)(mStrikeWidth / 2));
        canvas.drawCircle(mWidth >>> 1, mHeight >>> 1, value, mDrawPoint);
    }
